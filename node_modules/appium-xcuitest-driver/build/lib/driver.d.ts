...
export class XCUITestDriver extends BaseDriver<{
    ...
    mobileQueryAppState: (this: XCUITestDriver, bundleId: string) => Promise<import("./commands/enum").AppState>;
    installApp: (appPath: string, { timeoutMs, strategy }?: any) => Promise<void>;
    activateApp: (bundleId: string, opts?: any, ...args: any[]) => Promise<void>;
    ...
    mobileGetAppearance: (this: XCUITestDriver) => Promise<{
        style: import("./commands/types").Style;
    }>;
    mobilePerformAccessibilityAudit: (this: XCUITestDriver, auditTypes: string[] | null) => Promise<import("./commands/audit").AccessibilityAuditItem[]>;
    ...
    mobileGetDeviceInfo: (this: XCUITestDriver) => Promise<import("./commands/types").DeviceInfo | (import("./commands/types").DeviceInfo & import("./commands/types").LockdownInfo)>;
    ...
    getScreenInfo: (this: XCUITestDriver) => Promise<import("./commands/types").ScreenInfo>;
    ...
    mobileGetSimulatedLocation: (this: XCUITestDriver) => Promise<import("./commands/geolocation").GeolocationInfo>;
    ...
    }, durationSeconds: string | number) => Promise<unknown>;
    ...
    mobileKeys: (this: XCUITestDriver, keys: (string | import("./commands/types").KeyboardKey)[], elementId?: string | null | undefined) => Promise<unknown>;
    ...
    proxyCommand: <TReq = any, TRes = unknown>(this: XCUITestDriver, url: string, method: import("./commands/proxy-helper").AllowedHttpMethod, body?: TReq | undefined, isSessionCommand?: boolean) => Promise<TRes>;
    ...
    mobileUpdateSafariPreferences: (this: XCUITestDriver, preferences: import("@appium/types").StringRecord<any>) => Promise<void>;
